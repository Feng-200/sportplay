...
MySQL - 8.0.23 : Database - easyproject
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`easyproject` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
(11,'bbbbb','aaaaaaa','bbb@qq.com','普通用户',0);
...
CREATE TABLE `submenu2` (
  ...
  `spath` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `mid` int NOT NULL,
  PRIMARY KEY (`sid`),
  KEY `mid` (`mid`)
) ENGINE=InnoDB AUTO_INCREMENT=204 DEFAULT CHARSET=utf8;

/*Data for the table `submenu2` */

insert  into `submenu2`(`sid`,`stitle`,`spath`,`mid`) values 
(101,'用户列表','/user',100),
(102,'修改权限','/rights',100),
(103,' 运动模块','/sport',100),
(104,'商品模块','/goods',100),
